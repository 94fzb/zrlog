	...
	$(function(){
		...
		$('.colorpick-btn').on('click', function() {
            ...
            $.post('admin/website/update',{"admin_dashboard_skin":skin},function(data){
				if(data.success){
					/*$.gritter.add({
						title: '  操作成功...',
        ...
        $("#ace-settings-add-container").click(function(e){
        	...
        	$.post('admin/website/update',{"admin_dashboard_inside_container":status},function(data){
				if(data.success){
					/*$.gritter.add({
						title: '  操作成功...',
						class_name: 'gritter-success' + (!$('#gritter-light').get(0).checked ? ' gritter-light' : ''),
        ...
        $("#sidebar-collapse").click(function(e){
			...
			$.post('admin/website/update',{"admin_dashboard_sidebar_collapser":status},function(data){
				if(data.success){
					/*$.gritter.add({
						title: '  操作成功...',
						class_name: 'gritter-success' + (!$('#gritter-light').get(0).checked ? ' gritter-light' : ''),
