...
| 模块名称                                                                   | 最新版本情况                                                                                                                                                                             |
|--------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [基础核心库 (Base)](https://github.com/zrlog/zrlog-base)             | [![Maven Central](https://img.shields.io/maven-central/v/com.hibegin/zrlog-base.svg?label=Maven%20Central)](https://central.sonatype.com/artifact/com.hibegin/zrlog-base)               |
| [安装初始化系统 (Install)](https://github.com/zrlog/zrlog-install-web) | [![Maven Central](https://img.shields.io/maven-central/v/com.hibegin/zrlog-install-web.svg?label=Maven%20Central)](https://central.sonatype.com/artifact/com.hibegin/zrlog-install-web) |
| [前台页面渲染 (Pages)](https://github.com/zrlog/zrlog-blog-web-parent)    | [![Maven Central](https://img.shields.io/maven-central/v/com.hibegin/zrlog-blog-web.svg?label=Maven%20Central)](https://central.sonatype.com/artifact/com.hibegin/zrlog-blog-web)       |
| [管理后台系统 (Admin)](https://github.com/zrlog/zrlog-admin-web)     | [![Maven Central](https://img.shields.io/maven-central/v/com.hibegin/zrlog-admin-web.svg?label=Maven%20Central)](https://central.sonatype.com/artifact/com.hibegin/zrlog-admin-web)     |
...
WWW 由本工程的 `zrlog-web/pom.xml` 以 runtime 依赖组装；四款 Hexo 主题的 scope 使用
`${zrlog-polyglot-template-scope}`，与 Polyglot 引擎一起受打包 profile 控制。
