...
public class ServerInfoUtils {
    public static List<ServerInfo> convertToServerInfos(Map<String, Object> data) {
        ...
        systemInfo.add(new ServerInfo(I18nUtil.getBackendStringFromRes("serverInfo.system"), Constants.getRealFileArch() + " - " + data.get("os.version")));
        ...
        systemInfo.add(new ServerInfo(I18nUtil.getBackendStringFromRes("serverInfo.programInfo"), BlogBuildInfoUtil.getVersionInfo()));
        return systemInfo;
    }
}
