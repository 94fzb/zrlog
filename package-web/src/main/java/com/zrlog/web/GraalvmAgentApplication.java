...
public class GraalvmAgentApplication {
    ...
    private static void loadResource() {
        ...
        List<String> resourceNameList = InstallNativeImageResourceUtils.getResourceNameList();
        for (String resourceName : resourceNameList) {
            GraalvmAgentApplication.class.getResourceAsStream(resourceName);
        }
        ...
        webServerBuilder.addCreateSuccessHandle(() -> {
            ...
            try {
                FreeMarkerUtil.renderToFM("empty", HttpRequestBuilder.buildRequest(HttpMethod.GET, "/", "",
                        ...
                        webServerBuilder.getWebServer().getApplicationContext()));
            } catch (Exception e) {
