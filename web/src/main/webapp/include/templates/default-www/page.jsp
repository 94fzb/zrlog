...
<c:choose>
    ...
    <div class="category-title">
    	<h2>${tipsType}目录：${tipsName}</h2>
    	<h2>以下是与${tipsType} “${tipsName}” 相关联的文章</h2>
    </div>
    </c:if>
...
<h2 class="post-title"><a rel="bookmark" href="${log.url}">${log.title}</a></h2>
  <div class="content"><p>${log.digest}</p></div>
	  ...
	  <p class="published">/&nbsp;${log.releaseTime.year+1900}-${log.releaseTime.month+1}-${log.releaseTime.date}</p>
	  <p class="commentlink">
