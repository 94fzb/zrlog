...
public class DbUtils {
    ...
    public static DataSourceWrapper configDatabaseWithRetry(int timeoutInSeconds, ZrLogConfig zrLogConfig, Updater updater) {
        try {
            return (DataSourceWrapper) zrLogConfig.configDatabase();
        } catch (Exception e) {
            if (timeoutInSeconds > 0 && e instanceof SQLRecoverableException) {
                ...
                return configDatabaseWithRetry(timeoutInSeconds - seekSeconds, zrLogConfig, updater);
            }
