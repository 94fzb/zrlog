          ...
          <Link to="./upgrade">
            <Badge dot={layoutState.upgrade}>
              ...
              <Text style={{ paddingLeft: "12px" }}>
                {res["newVersion"]} - ({layoutState.newVersion}#
                {layoutState.versionType})
              </Text>
            </Badge>
          </Link>
        </Menu.Item>
                  ...
                  <Col xs={24} md={12}>
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html:
                          getRes().copyrightTips + ". All Rights Reserved.",
                      }}
                    />
                  </Col>
                  <Col xs={0} md={12}>
