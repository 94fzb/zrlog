...
import MyEditorMdWrapper, {
  ChangedContent,
} from "./editor/my-editormd-wrapper";
...
const ArticleEdit = () => {
      ...
      await axios
        ...
        .then(({ data }) => {
          ...
          if (release) {
            ...
            if (preview) {
              window.open(
                document.baseURI + "post/" + allValues!.logId,
                "_blank"
              );
            }
          }
  ...
  const save = async (article: ArticleEntry) => {
    ...
    try {
      ...
      setArticleState({ ...articleState, ...savedResult });
    } finally {
      saving = false;
    }
  };
      ...
      >
        ...
        <Row gutter={[8, 8]} style={{ paddingBottom: "5px" }}>
          ...
          <Col
            ...
            md={3}
            sm={6}
            className={state.fullScreen ? "save-btn-full-screen" : ""}
          >
            <Button
              id="save"
              type="primary"
                  ...
                  >
                    {(articleState!.thumbnail === undefined ||
                      ...
                      <>
                        ...
                        >
                          <CameraOutlined
                            style={{ fontSize: "28px", paddingTop: "40px" }}
                          />
                        </p>
