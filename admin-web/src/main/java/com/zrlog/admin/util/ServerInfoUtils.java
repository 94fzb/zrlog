    ...
    public static List<ServerInfo> getServerInfos2() {
        ...
        try {
            ...
            systemInfo.add(new ServerInfo(I18nUtil.getBackendStringFromRes("serverInfo.dbConnectSize"),
                    Constants.zrLogConfig.getDatabaseConnectPoolInfo().getConnectActiveSize() + " / " + Constants.zrLogConfig.getDatabaseConnectPoolInfo().getConnectTotalSize(), "dbConnectSize"));
