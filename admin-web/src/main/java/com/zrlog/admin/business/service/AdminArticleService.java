    ...
    private CreateOrUpdateArticleResponse save(AdminTokenVO adminTokenVO, CreateArticleRequest createArticleRequest) {
        ...
        try {
            ...
            if (createArticleRequest instanceof UpdateArticleRequest) {
                Log dbLog = new Log().findById(((UpdateArticleRequest) createArticleRequest).getLogId());
                Integer dbVersion = dbLog.getInt("version");
                if (dbVersion != null && dbVersion > ((UpdateArticleRequest) createArticleRequest).getVersion()) {
            ...
            updateLogResponse.setVersion(log.getInt("version"));
