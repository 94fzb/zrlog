...
public class TypeController extends BaseController {
    ...
    @ResponseBody
    public AdminApiPageDataStandardResponse<PageData<ArticleTypeResponseEntry>> index() throws SQLException {
        return new AdminApiPageDataStandardResponse<>(new ArticleTypeService().find(ZrLogUtil.getHomeUrlWithHost(request), ControllerUtil.unPageRequest(), Constants.isStaticHtmlStatus()));
    }
