...
public class TemplateController extends BaseController {
    ...
    @ResponseBody
    public AdminApiPageDataStandardResponse<TemplateVO> configParams() {
        String template = Constants.TEMPLATE_BASE_PATH + getParamWithEmptyCheck("shortTemplate");
        if (StringUtils.isEmpty(template)) {
            return new AdminApiPageDataStandardResponse<>();
        }
        return new AdminApiPageDataStandardResponse<>(templateService.loadTemplateConfig(template));
    }

    @ResponseBody
    public AdminApiPageDataStandardResponse<List<TemplateVO>> index() {
        return new AdminApiPageDataStandardResponse<>(templateService.getAllTemplates(TemplateHelper.getTemplatePathByCookie(getRequest().getCookies())));
    }
    ...
    public AdminApiPageDataStandardResponse<TemplateDownloadResponse> templateCenter() {
        ...
        return new AdminApiPageDataStandardResponse<>(downloadResponse);
    }
}
