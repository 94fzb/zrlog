...
./mvnw -Djakarta-scope='provided' -Pjava21-enabled,native -Dagent exec:exec@java-agent -U  -f package-web/pom.xml
./mvnw -Djakarta-scope='provided' -Pjava21-enabled,native package -U -f package-web/pom.xml
